...
1.  **Optimal Annealing Schedules**: as `2505.10559v1.pdf` demonstrates, we can use the physics of annealing to derive the optimal 1/t decay schedule for the learning rate. this allows us to cool the system in a way that avoids getting trapped in suboptimal minima, finding better final solutions faster.
